          ...
          <div className="flex flex-col pt-2">
            ...
            <div className="space-y-6 bg-gray-50/50 p-6 rounded-2xl border border-gray-100">
              ...
              <div className="space-y-3 pt-4 border-t border-gray-200/50">
                {logistics.isBulky && (
                  <div className="flex items-center gap-2.5 text-sm text-teal-900 bg-teal-50/80 p-3 rounded-xl border border-teal-200 font-medium">
                    <Truck className="w-5 h-5 text-teal-600 flex-shrink-0" />
                    <div>
                      <p className="font-semibold text-xs text-teal-900 uppercase tracking-wider mb-0.5">Heavy Item Delivery</p>
                      <p className="text-xs text-teal-700 font-normal">Flat ₹150 delivery fee (FREE on orders over ₹2,999)</p>
                    </div>
                  </div>
                )}
