...
import { Star, Heart, ShoppingCart, Minus, Plus, Shield, Truck, RotateCcw, ArrowLeft, ZoomIn, X, ChevronLeft, ChevronRight, Clock, Users, Eye, Share2, ChevronDown } from "lucide-react";
  ...
  return (
    <div className="min-h-screen bg-gray-50">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 mb-12">
          ...
          <div className="space-y-4">
            ...
            <div className="relative aspect-square bg-white rounded-lg overflow-hidden group">
              ...
              <div className="absolute top-4 left-4 bg-green-500 text-white px-3 py-1 rounded-full text-sm font-medium flex items-center space-x-1">
                ...
                <span>{recentlyViewed} viewing now</span>
              </div>
            </div>
                ...
                {images.map((image: string, index: number) => (
                  <button
                    ...
                    className={`aspect-square bg-white rounded-lg overflow-hidden border-2 transition-all duration-200 hover:scale-105 ${
                      selectedImageIndex === index ? "border-copper-600 shadow-lg" : "border-gray-200 hover:border-gray-300"
                    }`}
                  >
                    <img
                      src={image}
          ...
          <div className="space-y-6">
            <div>
              ...
              <div className="mb-6">
                {product.stock && product.stock > 0 ? (
                  <div className="space-y-2">
                    ...
                    {/* Delivery Estimate */}
                    <button 
                      onClick={() => setShowDeliveryEstimate(!showDeliveryEstimate)}
                      className="flex items-center space-x-1 text-blue-600 hover:text-blue-700 text-sm font-medium"
                    >
                      <Truck className="w-4 h-4" />
                      <span>Check delivery options</span>
                      <ChevronDown className={`w-4 h-4 transition-transform duration-200 ${showDeliveryEstimate ? 'rotate-180' : ''}`} />
                    </button>
              ...
              {/* Enhanced Features & Trust Badges */}
              <div className="mt-8 space-y-4">
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 p-4 bg-gradient-to-r from-green-50 to-blue-50 rounded-lg border border-green-200">
                  <div className="flex items-center space-x-2">
                  ...
                  <div className="flex items-center space-x-2">
                    ...
                    <span className="text-sm font-medium text-gray-700">Free Shipping ₹500+</span>
                  </div>
                  <div className="flex items-center space-x-2">
          ...
          <div className="flex items-center space-x-4 overflow-x-auto pb-4">
            ...
            <div className="flex-shrink-0">
              <div className="w-24 h-24 bg-gray-100 rounded-lg flex items-center justify-center">
                <img src={images[0]} alt={product.name} className="w-full h-full object-cover rounded-lg" />
              </div>
              <p className="text-xs text-center mt-2 font-medium">{formatPrice(price)}</p>
            </div>
            ...
            <div className="flex-shrink-0">
              <div className="w-24 h-24 bg-gray-100 rounded-lg flex items-center justify-center">
                <img src="https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=200" alt="Wire Connector" className="w-full h-full object-cover rounded-lg" />
              </div>
              <p className="text-xs text-center mt-2 font-medium">{formatPrice(299)}</p>
            </div>
            ...
            <div className="flex-shrink-0">
              <div className="w-24 h-24 bg-gray-100 rounded-lg flex items-center justify-center">
                <img src="https://images.unsplash.com/photo-1621905252507-b35492cc74b4?w=200" alt="Electrical Tape" className="w-full h-full object-cover rounded-lg" />
              </div>
              <p className="text-xs text-center mt-2 font-medium">{formatPrice(149)}</p>
            </div>
            ...
            <div className="flex-shrink-0 text-center">
              <div className="bg-green-100 p-4 rounded-lg">
                ...
                <p className="text-xl font-bold text-green-700">{formatPrice(price + 299 + 149 - 100)}</p>
                <p className="text-xs text-green-600">Save {formatPrice(100)}</p>
              </div>
            ...
            <div className="bg-white rounded-lg p-6">
              ...
              <div className="mb-6 pb-6 border-b border-gray-200">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div>
                    ...
                    <div className="space-y-2">
                      <Button variant="outline" size="sm" className="mr-2 mb-2">All Reviews</Button>
                      <Button variant="outline" size="sm" className="mr-2 mb-2">5 Stars</Button>
                      <Button variant="outline" size="sm" className="mr-2 mb-2">4 Stars</Button>
                      <Button variant="outline" size="sm" className="mr-2 mb-2">With Photos</Button>
                      <Button variant="outline" size="sm" className="mr-2 mb-2">Verified Purchase</Button>
                    </div>
                  </div>
                </div>
              </div>
              ...
              {reviews.length > 0 ? (
                <div className="space-y-6">
                  ...
                  <div className="border-b border-gray-200 pb-6">
                    ...
                    <p className="text-gray-700 mb-3">
                      This LED flood light exceeded my expectations. The brightness is perfect for my warehouse, 
                      and the build quality feels very solid. Installation was straightforward with the included mounting hardware.
                    </p>
                    
                    {/* Customer Photos */}
                    <div className="flex space-x-2 mb-3">
                      <img src="https://images.unsplash.com/photo-1621905252507-b35492cc74b4?w=100&h=100&fit=crop" alt="Customer photo" className="w-16 h-16 object-cover rounded-lg" />
                      <img src="https://images.unsplash.com/photo-1558618666-fcd25c85cd64?w=100&h=100&fit=crop" alt="Customer photo" className="w-16 h-16 object-cover rounded-lg" />
                    </div>
                ...
                <div className="text-center py-12">
                  ...
                  <h3 className="text-lg font-medium text-gray-900 mb-2">Be the first to review!</h3>
      ...
      <div className="fixed bottom-4 left-4 z-40 space-y-2">
        <div className="bg-white border border-gray-200 rounded-lg p-3 shadow-lg max-w-sm animate-in slide-in-from-left-5 duration-500">
          <div className="flex items-center space-x-2">
