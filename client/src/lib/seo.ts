...
export const SEO_CONFIG = {
  ...
  default: {
    ...
    description: `Buy premium electrical products online from Madurai. Fast delivery across Tamil Nadu and North India. Circuit breakers, wiring, tools & more. Free shipping on orders ${formatPrice(SHIPPING_THRESHOLDS.FREE_STANDARD)}+. Serving ${SERVICE_AREAS.tamilNadu.slice(0, 4).join(', ')}, Delhi, Jaipur & all major cities.`,
  ...
  pages: {
    home: {
      ...
      description: `India's trusted electrical products store based in Madurai. Shop circuit breakers, cables, tools & more. Free delivery Tamil Nadu & North India on orders ${formatPrice(SHIPPING_THRESHOLDS.FREE_STANDARD)}+. Licensed electricians available. Serving Madurai, Chennai, Delhi, Jaipur & 500+ cities.`,
    ...
    products: {
      ...
      description: `Browse 1000+ electrical products with fast delivery from Madurai to North India. Premium quality circuit breakers, wiring cables, tools & accessories. Free shipping on ${formatPrice(SHIPPING_THRESHOLDS.FREE_STANDARD)}+. Serving Tamil Nadu, Delhi, UP, Rajasthan & all India.`,
    ...
    cart: {
      ...
      description: `Review your electrical products order. Fast delivery from Madurai to Tamil Nadu and North India. Free shipping on orders above ${formatPrice(SHIPPING_THRESHOLDS.FREE_STANDARD)}. Secure checkout available.`,
  ...
  category: (categoryName: string) => ({
    ...
    description: `Shop premium ${categoryName.toLowerCase()} online with fast delivery from Madurai to North India. Authentic products, competitive prices, free shipping ${formatPrice(SHIPPING_THRESHOLDS.FREE_STANDARD)}+. Serving Tamil Nadu, Delhi, UP, Rajasthan & all India.`,
  ...
  product: (productName: string, category: string, price: number) => ({
    ...
    description: `Buy ${productName} online at ₹${price.toLocaleString('en-IN')}. Fast delivery from Madurai to Tamil Nadu and North India. Premium quality ${category.toLowerCase()}. Free shipping on orders ${formatPrice(SHIPPING_THRESHOLDS.FREE_STANDARD)}+. COD available in Tamil Nadu.`,
